    ...
    return (
        <div className="relative bg-[#111]">
            ...
            <div className="relative">
                ...
                <p className="absolute font-bold text-4xl lg:text-6xl text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">{t('projects_menuList_4')}</p>
            </div>
