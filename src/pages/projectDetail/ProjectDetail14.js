    ...
    return (
        <div className="relative bg-[#111]">
            ...
            <div className="relative">
                <img src="/images/projects/14_bupyeong_ar/bupyeong_ar_detail_bg.png" alt="projects_detail_bg"
            ...
            <div className="px-5 pt-10 pb-[60px] lg:px-60 lg:pt-[140px] lg:pb-60">
                <h1 className="font-bold text-2xl lg:text-[3.5em] text-white lg:leading-normal">스마트 부평역사박물관 증강현실 앱</h1>
            ...
            <div className="px-5 lg:px-60">
                ...
                스마트 부평역사박물관 증강현실 앱<br/>
                </p>
                <span
                    className="text-[#f0f0f0] lg:text-lg pt-5 lg:pt-8 pb-10 lg:pb-[60px] block leading-6 lg:leading-8">
                    AR콘텐츠와 함께 하는 똑똑한 박물관 관람 <br/>
                    부평역사박물관에 방문하셔서 현장에서 휴대폰이나 태블릿의 카메라를 이용하여 전시실 곳곳을 둘러보세요. <br/>
                </span>
                <img src="/images/projects/14_bupyeong_ar/bupyeong_ar_img1.png" alt="ganghwa_ar_img1"/> <br/>
                <img src="/images/projects/14_bupyeong_ar/bupyeong_ar_img2.png" alt="ganghwa_ar_img2"/> <br/>
                <img src="/images/projects/14_bupyeong_ar/bupyeong_ar_img3.png" alt="ganghwa_ar_img3"/> <br/>
