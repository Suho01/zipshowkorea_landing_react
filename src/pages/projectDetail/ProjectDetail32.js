    ...
    return (
        <div className="relative bg-[#111]">
            ...
            <div className="relative">
                <img src="/images/projects/projects_detail_bg.png" alt="projects_detail_bg"
            ...
            <div className="px-5 pt-10 pb-[60px] lg:px-60 lg:pt-[140px] lg:pb-60">
                <h1 className="font-bold text-2xl lg:text-[3.5em] text-white lg:leading-normal">국립세계문자박물관 AI 인터랙티브 미디어아트 '문자로 그리는 미래'</h1>
                    ...
                    >
                        {
                            Array(4).fill().map((_, i) => {
                                return (
                                    <SwiperSlide>
                                        <img src={`/images/projects/experience${i + 1}.png`}
                                             alt={`experience${i + 1}`}/>
                                    </SwiperSlide>
                                );
                            })
