    ...
    return (
        <div className="relative bg-[#111]">
            ...
            <div className="px-5 pb-10 lg:px-60 lg:pb-[200px]">
                ...
                <iframe src="https://www.youtube.com/embed/Lhado5b408c?si=-tT1Ulhe4FHu3Mj9" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen className='w-full aspect-[16/9]'></iframe>
                <br/>
                <img src="/images/projects/01_munja/munja_img3.png" alt="munja_image2"/>
                <br/>
                <br/>
                ...
                <div className="lg:flex flex-wrap gap-5 hidden">
                    {
                        Array(4).fill().map((_, i) => {
                            return (
                                <img src={`/images/projects/01_munja/munja_experience${i + 1}.png`} alt={`experience${i + 1}`}
